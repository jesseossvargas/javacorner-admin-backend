...
public class CourseServiceImpl implements CourseService{
	...
	public CourseDTO createCourse(CourseDTO courseDTO) {
		...
		return courseMapper.fromCourse(courseDao.save(course));
	}
	...
	@Override
	public Page<CourseDTO> findCoursesForStudent(Long studentId, int page, int size) {
		PageRequest pageRequest= PageRequest.of(page, size);
	...
	public Page<CourseDTO> fetchNonEnrolledInCoursesForStudent(Long studentId, int page, int size) {
		PageRequest pageRequest= PageRequest.of(page, size);
		Page<Course> nonEnrrolledInCoursesPage = courseDao.getNonEnrrolledInCoursesByStudentId(studentId, pageRequest);
		return new PageImpl<>(nonEnrrolledInCoursesPage.getContent().stream().map(course -> courseMapper.fromCourse(course)).collect(Collectors.toList()), pageRequest, nonEnrrolledInCoursesPage.getTotalElements());
	}
